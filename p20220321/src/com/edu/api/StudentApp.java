...
public class StudentApp {
	...
	List<Student> list = new ArrayList<Student>();// << 컬렉션이라고 하는듯
	Scanner scn = new Scanner(System.in);

	// 생성자
	public StudentApp() {// 기본 생성자
		list.add(new Student(101, "황근출", 100, 100));
		list.add(new Student(102, "톤톤정", 100, 100));
		list.add(new Student(103, "이유빈", 20, 100));
	...
	class StudentServiceImp1 implements StudentService {
		...
		public void execute() {
			StudentService service = new StudentServiceImp1();// 메인 기능을 하는 메소드.
